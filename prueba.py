...
listado = []
asiento = []
lugarescogido = ["(0)Miami beach","(1)Moscow","(2)Brasil","(3)Argentina","(4)Bolivia","(5)EEUU"]
ubicacionesdisponible = ("(0)Miami beach","(1)Moscow","(2)Brasil","(3)Argentina","(4)Bolivia","(5)EEUU")
print("-----------------------------------------------------------------------------")
